      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        <Reveal>
          ...
          <h2 className="font-display mt-4 max-w-2xl text-4xl leading-tight text-charcoal-950 sm:text-5xl">
            Six regions, one incredible India
          </h2>
        </Reveal>
            ...
            <Reveal key={region.slug} delay={i * 0.06}>
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-6">
                  <h3 className="font-display text-2xl text-cream-50">{region.title}</h3>
                  <p className="mt-2 text-sm text-cream-100/80">{region.description}</p>
                </div>
              </Link>
            </Reveal>
          ))}
