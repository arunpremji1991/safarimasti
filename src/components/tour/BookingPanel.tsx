  ...
  return (
    <>
      ...
      <div className="sticky top-28 hidden rounded-2xl border border-charcoal-950/10 bg-cream-50 p-6 shadow-sm lg:block">
        <p className="text-xs font-semibold uppercase tracking-widest text-maroon-700">Price</p>
        <p className="font-display mt-1 text-2xl text-charcoal-950">Request a Quote</p>
        <p className="mt-1 text-sm text-charcoal-800/60">
          Priced around your dates, group size and travel style.
        </p>
        ...
        <div className="mt-6 space-y-2 border-t border-charcoal-950/10 pt-5 text-sm text-charcoal-800/70">
          ...
          <a href={site.emailHref} className="block hover:text-maroon-700">
            {site.email}
          </a>
        </div>
      </div>
